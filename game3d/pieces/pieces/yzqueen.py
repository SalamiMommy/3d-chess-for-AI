...
Exports:
  generate_yz_queen_moves(cache_manager, color, x, y, z) -> list[Move]
...
from game3d.movement.movepiece import Move  # Add missing import
...
def generate_yz_queen_moves(
    ...
    color: Color,
    x: int, y: int, z: int
) -> List[Move]:  # FIXED: Add return type annotation
