...
def generate_slower_moves(  # slower_moves or speeder_moves
...
def debuffed_squares(  # debuffed_squares or buffed_squares
...
def slower_move_dispatcher(state: 'GameState', x: int, y: int, z: int) -> List[Move]:
    return generate_slower_moves(state.cache_manager, state.color, x, y, z)
