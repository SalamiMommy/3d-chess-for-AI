...
from game3d.common.diagnostics import print_cache_report, get_cache_stats
...
def test_cache_usage():
    ...
    """
    from game3d.common.diagnostics import get_diagnostics
    from game3d.game.game3d import OptimizedGame3D
