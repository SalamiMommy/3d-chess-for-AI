...
class MoveCache:
    ...
    def get_cached_moves(self, color: int) -> Optional[np.ndarray]:
        ...
        ✅ CRITICAL FIX: Don't invalidate on generation change alone.
    ...
    def store_moves(self, color: int, moves: np.ndarray) -> None:
        ...
        with self._lock:
            ...
            # 🚨 NEVER cache empty moves unless truly stalemate
            if moves.size == 0:
                piece_count = len(self.cache_manager.occupancy_cache.get_positions(color))
                if piece_count > 0:
                    logger.error(
                        f"🚨 REFUSING to cache 0 moves for {piece_count} pieces. "
    ...
    def invalidate(self) -> None:
        ...
        with self._lock:
            self._cached_moves[0] = None  # ✅ FIXED: Use None
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        with self._lock:
            ...
            return {
                ...
                'prune_operations': self._prune_triggered  # ✅ NEW: Track pruning
            }
