...
def geomancer_move_dispatcher(board, color, *coord, cache=None) -> List[Move]:
def geomancer_move_dispatcher    from game3d.game.gamestate import GameState
def geomancer_move_dispatcher    state = GameState(board, color, cache=cache)
