...
def generate_yz_queen_with_king_moves    from game3d.game.gamestate import GameState
def generate_yz_queen_with_king_moves    state = GameState(board, color, cache=cache)
...
def yz_queen_move_dispatcher    from game3d.game.gamestate import GameState
def yz_queen_move_dispatcher    state = GameState(board, color, cache=cache)
