...
def generate_mirror_teleport_with_king_moves    from game3d.game.gamestate import GameState
def generate_mirror_teleport_with_king_moves    state = GameState(board, color, cache=cache)
...
def mirror_teleport_move_dispatcher(board, color, *coord, cache=None) -> List[Move]:
    """
    Registered dispatcher for Mirror-Teleport moves.
